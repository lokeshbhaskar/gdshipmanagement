      ...
      <div className="p-4 mt-5 md:p-10 xl:px-30">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 bg-white/95 p-8 md:p-12 rounded-3xl shadow-xl relative z-20 flex flex-col justify-start">
            <h2 className="text-2xl md:text-4xl font-bold mb-5 text-[#1A334E]">
              Who We Are
            </h2>
            <p>
              GDSHIP is a <strong>versatile organization</strong> dedicated to
              delivering{" "}
              <mark>
                comprehensive Ship Management, Quality Management, Crew
                Management, and Customized Training Services
              </mark>
              .
            </p>
            <p>
              Our <strong>primary commitment</strong> lies in providing
              <span className="text-primary">
                top-tier Ship Management Services
              </span>
              , ensuring the <strong>efficient and profitable operation</strong>
              of vessels under our management for Ship Owners
              <em className="global">worldwide</em>.
            </p>
              ...
              {Array.from({ length: rows * cols }).map((_, i) => (
                <div
                  ...
                  className={`rounded-md border border-gray-300 ${
                    i % 2 === 0 ? "bg-gray-400/30" : "bg-transparent"
                  } aspect-square`}
                ></div>
              ))}
            </div>
